...
if not st.session_state.authenticated:
    ...
    sample_questions = [
        ...
        "Give me top 3 cites that generated highest revenue?"
    ...
    # 🧩 DEBUG: See the SQL generated by LLM
                    st.write("🔍 Generated SQL:", sql)
    
                    if sql:
                        results = run_snowflake_query(sql)

        # 🧩 DEBUG: See what Snowflake returned
                        st.write("📊 Query Results (raw):", results)
